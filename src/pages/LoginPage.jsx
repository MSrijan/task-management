...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('This feature is not available as of right now')
  };
    ...
    <div className="flex justify-center">
      <div className="w-full max-w-md p-6 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300 ease-in-out"
          >
            Login
          </button>
        </form>
